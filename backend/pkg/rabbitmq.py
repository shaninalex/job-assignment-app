...
from database import Candidate, CompanyManager, Company, Auth, ConfirmCode, ConfirmStatusCode
...
async def confirm_account(session: AsyncSession, channel: BlockingChannel, auth: Auth, name: str):
    async with session:
